      ...
      <div className="container">
        <div className="about-grid">
          ...
          <div className="about-content slide-up" style={{ animationDelay: '0.15s' }}>
            ...
            <h2>Tal Menina, Tal Boneca</h2>

            <p className="about-text">
              Acreditamos que a moda infantil vai além do vestir. A La Villa Bambini traz 
            ...
            <p className="about-text">
              Nosso conceito é criar memórias mágicas através de peças coordenadas. Seja caminhando 
              no condomínio, ou apenas brincando no chão, a menina e sua boneca preferida estarão 
              igualmente vestidas, fortalecendo laços e encantando por onde passam.
            </p>
