        ...
        {isSuccess ? (
          <div className="success-view slide-up">
            ...
            <div className="success-content">
              ...
              <p>
                As roupas do/a <strong>{formData.childName || 'seu pequeno'}</strong> estarão a caminho em breve para você provar com calma.
              </p>
          ...
          <div className="checkout-form-container">
            ...
            <form onSubmit={handleCheckoutSubmit} className="checkout-form">
              ...
              <div className="form-group">
                <label htmlFor="checkout-child">Nome da Criança</label>
                <input
                  id="checkout-child"
                  type="text"
