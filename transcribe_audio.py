...
try:
    result = model.transcribe("WhatsApp Ptt 2026-05-15 at 10.14.08.ogg", language="pt")
    
    with open("transcricao_audio.txt", "w", encoding="utf-8") as f:
        f.write(result["text"])
    
    print("Transcricao concluida:")
    print(result["text"])
    print("\nTranscricao salva em transcricao_audio.txt")
except Exception as e:
